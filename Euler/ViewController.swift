...
class ViewController: UIViewController, GADBannerViewDelegate {
    ...
    @IBAction func tryAgain(_ sender: Any) {
        ...
        for i in 1...10 {
            self.view.viewWithTag(i)?.isUserInteractionEnabled = true
        }
    }
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-2723394137854237/9524455243"
        bannerView.rootViewController = self
        bannerView.delegate = self
        r.testDevices = [kGADSimulatorID]
        bannerView.layer.zPosition = 22
...
//        print(String(e[eulerPosition + 1]) == input)
    ...
    func animateIn() {
        ...
        visualEffectView.layer.zPosition = 20 // overkill much?
        gameOverView.layer.zPosition = 21 // overkill much?
    ...
    func defeatUser() {
        ...
        bannerView.load(r)
        for i in 1...10 {
            self.view.viewWithTag(i)?.isUserInteractionEnabled = false
        }
